...
?>
            ...
            <div class="row gx-4 gx-lg-5 justify-content-center">
                ...
                <?php foreach($rows as $row) : ?>
                    ...
                    <div class="post-preview">
                        <a href="https://localhost/clean-blog/posts/post.php?post_id=<?php echo $row->id;?>">
            ...
            <div class="row gx-4 gx-lg-5 justify-content-center">
                ...
                <?php foreach ($category as $cat) : ?>
                        <div class="col-md-6">
                        <a href="https://localhost/clean-blog/categories/category.php?cat_id=<?php echo $cat->id;?>">
